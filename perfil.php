...
//Se comprueba si existe una variable de sesión
...
$stmt = $conexion->prepare('SELECT password, email FROM usuario WHERE id = ?');
...
<body class="loggedin">
    <nav class="navtop">
        <h1 style="color:white;" align=""rigth>Sistema de Login Básico ConfiguroWeb</h1>
